...
class BouncedMessage implements ModelInterface
{
     ...
     * @var \DateTimeInterface|null
     */
    private $bounceReceived;

    /**
     * @var string|null
     */
    private $bounceSnippet;
    ...
    public function setBounceReceived(?\DateTimeInterface $bounceReceived = null): self
    {
    ...
    public function getBounceReceived(): ?\DateTimeInterface
    {
        return $this->bounceReceived;
    }

    public function setBounceSnippet(?string $bounceSnippet = null): self
    {
        $this->bounceSnippet = $bounceSnippet;

        return $this;
    }

    public function getBounceSnippet(): ?string
    {
        return $this->bounceSnippet;
    }

    public function setBounceSubType(?string $bounceSubType = null): self
    {
    ...
    public function setBounceType(?string $bounceType = null): self
    {
